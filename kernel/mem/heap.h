...
#define HILIX_HEAP_START		0xC0000000
#define HILIX_HEAP_INITIAL_SIZE	0x100000
#define HILIX_HEAP_INDEX_SIZE	0x20000
#define HILIX_HEAP_MAGIC		0x123890AB
#define HILIX_HEAP_MIN_SIZE	0x70000
