...
void init_paging()
{
	...
	int i = 0;
	for (i = HILIX_HEAP_START; i < HILIX_HEAP_START + HILIX_HEAP_INITIAL_SIZE; i += 0x1000)
	{
	...
	hilix_heap = create_heap(HILIX_HEAP_START, HILIX_HEAP_START + HILIX_HEAP_INITIAL_SIZE, 0xCFFFF000, 0, 0);
